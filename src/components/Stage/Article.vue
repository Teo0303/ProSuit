    ...
    <div class="content flex article-content">
      <article class="main-bg">
        ...
        <div class="btn-group flex space-between">
          ...
          <button class="btn btn-primary ps-64 btn-dark">Я прочитал материал</button>
        </div>
      </article>
      ...
      musicPlaylist: [
        {
          ...
          url:
            "../assets/Audio/Women_and_Girls_Laughing_-_Female_Laughter_Sound_Effects_High_Quality.mp3",
